...
public partial class WebSocketServer : Node2D
{
    ...
    [Signal] public delegate void MessageReceivedEventHandler(int peerId, Variant message);
    ...
    public Error Send(int peerId, Variant message)
    {
